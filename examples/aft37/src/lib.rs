...
#[allfeat_contracts::implementation(AFT37)]
...
pub mod my_aft37 {
    ...
    impl Contract {
        ...
        #[ink(message)]
        pub fn mint_tokens(&mut self, id: Id, amount: Balance) -> Result<(), AFT37Error> {
    ...
    pub mod tests {
        ...
        async fn balance_of_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let address = client
                .instantiate("my_aft37", &ink_e2e::alice(), constructor, 0, None)
                .await
