...
pub mod my_aft34 {
    ...
    impl Contract {
        ...
        #[ink(message)]
        pub fn mint_token(&mut self) -> Result<(), AFT34Error> {
            aft34::Internal::_mint_to(self, Self::env().caller(), Id::U8(self.next_id))?;
            self.next_id += 1;
            Ok(())
        }

        #[ink(message)]
        pub fn mint(&mut self, id: Id) -> Result<(), AFT34Error> {
            aft34::Internal::_mint_to(self, Self::env().caller(), id)
        }
    }

    #[cfg(all(test, feature = "e2e-tests"))]
    pub mod tests {
        use allfeat_contracts::aft34::aft34_external::AFT34;
        #[rustfmt::skip]
        use super::*;
        #[rustfmt::skip]
        ...
        async fn return_collection_id_of_account(
            ...
            let address = client
                .instantiate("my_aft34", &ink_e2e::alice(), constructor, 0, None)
                .await
        ...
        #[ink_e2e::test]
        async fn aft34_transfer_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            let constructor = ContractRef::new();
            let address = client
                .instantiate("my_aft34", &ink_e2e::alice(), constructor, 0, None)
                .await
        ...
        async fn can_nextot_transfer_non_existing_token(
            ...
            assert!(matches!(transfer_result, Err(AFT34Error::TokenNotExists)));
            assert_eq!(balance_of!(client, address, alice), 0);
        ...
        async fn cannot_transfer_without_allowance(
            ...
            assert!(matches!(transfer_result, Err(AFT34Error::NotApproved)));
