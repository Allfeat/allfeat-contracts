...
#[allfeat_contracts::implementation(AFT22, AFT22Metadata)]
#[allfeat_contracts::contract]
pub mod my_aft22_metadata {
    ...
    impl Contract {
        ...
        pub fn new(
            ...
            aft22::Internal::_mint_to(&mut instance, caller, total_supply)
    ...
    pub mod tests {
        use allfeat_contracts::aft22::extensions::metadata::aft22metadata_external::AFT22Metadata;
        ...
        async fn metadata_works(client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let address = client
                .instantiate("my_aft22_metadata", &ink_e2e::alice(), constructor, 0, None)
                .await
